...
import SendersFellowship from '../SendersFellowship'
import GenTwelve from '../GenTwelve'
    ...
    <div className="App">
       <Router>
          <Switch>
            ...
            <Route path='/senders-fellowship' component={SendersFellowship} />
            <Route path='/gen-twelve' component={GenTwelve} />
